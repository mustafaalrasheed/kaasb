...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("draft", "pending_review", "active", "paused", "rejected", "archived", name="gigstatus", create_type=False), nullable=False, server_default="pending_review"),
    ...
    op.create_table(
        ...
        sa.Column("tier", sa.Enum("basic", "standard", "premium", name="gigpackagetier", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("pending", "in_progress", "delivered", "revision_requested", "completed", "cancelled", "disputed", name="gigorderstatus", create_type=False), nullable=False, server_default="pending"),
